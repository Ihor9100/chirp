...
fun getDeviceConfiguration(): DeviceConfiguration {
  ...
  return DeviceConfiguration.get(windowSizeClass)
}
...
enum class DeviceConfiguration {
  ...
  companion object {
    fun get(windowSizeClass: WindowSizeClass): DeviceConfiguration {
      return with(windowSizeClass) {
        when {
          ...
          minWidthDp >= WindowSizeClass.HEIGHT_DP_EXPANDED_LOWER_BOUND &&
